...
const Modal = () => {
  ...
  return (
    <section className="bg-[#e1ebfa] flex items-center justify-center py-12">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold text-black mb-6 leading-tight">
          Join Our Community of
          {/* <span className="block text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-indigo-400"> */}
          <span className="block text-transparent bg-clip-text bg-gradient-to-r from-violet-800 to-indigo-800">
            Passionate Writers!
          </span>
        </h2>
        <p className="text-black mb-8 max-w-2xl mx-auto text-lg font-semibold">
          Unleash your creativity, share your stories, and connect with fellow
          writers from around the world. Start your journey today!
        </p>
        <motion.button
          ...
          className="bg-[#3e95fb] text-white font-medium px-8 py-3 rounded-full text-lg shadow-lg hover:shadow-indigo-500/50 transition-shadow duration-300 flex items-center justify-center mx-auto"
          // className="bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-medium px-8 py-3 rounded-full text-lg shadow-lg hover:shadow-indigo-500/50 transition-shadow duration-300 flex items-center justify-center mx-auto"
        >
          <FiEdit3 className="mr-2" />
          Create your own blog
